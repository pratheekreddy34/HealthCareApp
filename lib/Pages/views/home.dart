...
import 'package:flutter_app/Pages/data/data.dart';
import 'package:flutter_app/Pages/model/speciality.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'doctor_info.dart';
import 'package:flutter_app/Pages/prescriptions.dart';
import 'nodocs.dart';
        ...
        child: ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              ...
              accountEmail: new Text('$email_user'),
...
class SpecialistTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => nodoctors()));
      },
      child: Container(
        width: 150,
